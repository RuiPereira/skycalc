...
\begsubsect{Specifying ra and dec ({\tt r} and {\tt d}, or {\tt C}); 
hourly airmass ({\tt h})}
...
Colons (or almost any other character) will also work
...
The {\tt C} (for `coordinates') command lets you enter the
...
Proper motions may be included (see below).  The first line of this 
block also notes the constellation in which the coordinates lie, based
on the IAU constellation boundaries.
\par
...
A note on definitions: the {\sl barycenter} is the solar system's center
